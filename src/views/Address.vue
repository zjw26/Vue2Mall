        ...
        <div class="container">
            ...
            <div class="addr-list-wrap">
                ...
                <ul>
                    ...
                    <div class="addr-opration addr-set-default">
                        <a href="javascript:;" class="addr-set-default-btn" @click="setDeault(item.addressId)" v-if="!item.isDefault"><i>Set default</i></a>
                    </div>
            ...
            <div class="order-foot-wrap">
                ...
                <div class="next-btn-wrap">
                    <router-link class="btn btn--m btn--red" to="/orderConfirm" :to="{path:'/orderConfirm',query:{'addressId':selectAddressId}}">Next</router-link>
                </div>
            </div>
            </div>
        </div>
    ...
    <div class="md-modal modal-msg md-modal-transition md-show" v-if="mdShowAddress">
        <div class="md-modal-inner">
            <div class="md-top">
                ...
                <button class="md-close" @click="mdShowAddress=false">Close</button>
            </div> 
