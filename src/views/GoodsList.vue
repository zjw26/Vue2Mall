<template>
    <div>
        ...
        <div class="container">
            ...
            <a href="javascript:void(0)" class="price" @click="changeSort()" style="position:relative;">Price <img src="./../../static/箭头-下.svg" alt="" style="position:absolute;height:15px;margin-top:20px;" class='icon-arrow' v-bind:class="{'sort-up':sortFlag}"></a>
            ...
            <div class="filter stopPop" id="filter" :class="{'filterby-show' : filterShow}">
                ...
                <dt>Price:</dt>
                <dd><a href="javascript:void(0)" :class="{'cur':curPrice === 'all'}" @click = "setPriceFilter('all')">All</a></dd>
